...
namespace Collision
{
    public class Ball2D : MonoBehaviour
    {
        ...
        public bool IsCollidingWith(Wall2D other)
        {
            ...
            // VectorB.
            //
            float proj = Vector3.Dot(lineToPointVec, other.wallVec) / Vector3.Dot(other.wallVec, other.wallVec);
            Vector3 projVector = proj * other.wallVec;
            ...
            //
            float distanceFromLine = Vector3.Distance(lineToPointVec,projVector);
